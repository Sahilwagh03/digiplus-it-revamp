...
type GlassdoorLogoProps = React.SVGProps<SVGSVGElement>;

const GlassdoorLogo: React.FC<GlassdoorLogoProps> = (props) => {
  return (
    <svg
      width={40}
      height={40}
